...
public:
    CzPSCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministiczPSC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
